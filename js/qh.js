...
<div class="note info modern"><p>非商免字体未经授权只能个人使用。本站为完全非商业、非盈利性质的网站，平时用于个人学习交流，如有侵权请联系站长删除，谢谢！ —— 致版权方 </p>
    ...
    <a class="swf" id="swf_ZhuZiAWan" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZhuZiAWan'!important;color:black" onclick="setFont('ZhuZiAWan')">系统默认</a>
     ...
     <h2 id="图片（电脑）"><a href="#图片（电脑）" class="headerlink" title="图片（电脑）"></a>图片（电脑）</h2>
      ...
      <div class='content'>
      <div class="bgbox">
        <a href="javascript:;" style="background-image:url(/img/bz/1.jpg)" class="imgbox"
           onclick="changeBg('url(/img/bz/1.jpg)')"></a>
        <a href="javascript:;" style="background-image:url(/img/bz/2.jpg)" class="imgbox"
           onclick="changeBg('url(/img/bz/2.jpg)')"></a>
        <a href="javascript:;" style="background-image:url(/img/bz/3.jpg)" class="imgbox"
           onclick="changeBg('url(/img/bz/3.jpg)')"></a>     
        <a href="javascript:;" style="background-image:url(/img/bz/4.jpg)" class="imgbox"
           onclick="changeBg('url(/img/bz/4.jpg)')"></a>  
        <a href="javascript:;" style="background-image:url(/img/bz/5.jpg)" class="imgbox"
           onclick="changeBg('url(/img/bz/5.jpg)')"></a>  
    </div>
